...
class Lane_Detection(object):
    ...
    def steer(self, frame, lane_lines):
        ...
        self.curr_steering_angle = stabilize_steering_angle(self.curr_steering_angle,
                                                            new_steering_angle, len(lane_lines))

        self.steer_obj.Set_Line(self.curr_steering_angle)
